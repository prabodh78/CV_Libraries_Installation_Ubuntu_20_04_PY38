...
class MemoryDataLayer : public BaseDataLayer<Dtype> {
 public:
  ...
  virtual inline int ExactNumBottomBlobs() const { return 0; }
  //virtual inline int ExactNumTopBlobs() const { return 2; }
  virtual inline int ExactNumTopBlobs() const { return 3; } // Martin Kersner, 2016/04/06
 ...
 protected:
  ...
  Dtype* data_;
  Dtype* labels_;
  Dtype* data_dim_; // Martin Kersner, 2016/04/06
  int n_;
  int pos_;
  Blob<Dtype> added_data_;
  Blob<Dtype> added_label_;
  Blob<Dtype> added_data_dim_; // Martin Kersner, 2016/04/06
  bool has_new_data_;
};
