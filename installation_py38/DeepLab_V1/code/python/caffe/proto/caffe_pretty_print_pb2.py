...
import caffe_pb2 as caffe__pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[caffe__pb2.DESCRIPTOR,])
...
_NETPARAMETERPRETTYPRINT.fields_by_name['layers'].message_type = caffe__pb2._LAYERPARAMETER
